	...
	<body>
      ...
      ?>
        ...
        <div class="tab">
            ...
            <button class="tablinks" onclick="openCity(event, 'вход2')">Вход для сотрудников</button>
            <button class="tablinks" onclick="openCity(event, 'вход3')">Вход для проверяющих</button>
          ...
          <div id="регистрация" class="tabcontent">
            ...
            <form action="action_page2.php" method="post">
                <div class="container mt-4">
                  ...
                  <input type="text" placeholder="введите ваш город" name="city" required>

                  <label for="street"><b>enter street</b></label>
                  <input type="text" placeholder="введите вашу улицу" name="street" required>

                  <label for="home"><b>enter home</b></label>
                  <input type="text" placeholder="введите ваш дом" name="home" required>
                  <hr>
          ...
          <div id="обратная связь" class="tabcontent">
            <!--форма для заявки-->    
                ...
                <div class="container mt-4">
                  ...
                  <button tupe="submit" id="sendMail" name="submit">Отправить</button>
